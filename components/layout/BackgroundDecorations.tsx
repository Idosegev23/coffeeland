...
const decorations = [
  ...
  { src: '/coffebeans.svg', mobileSize: 90, desktopSize: 280, opacity: 0.24, top: '20%', left: '3%', rotation: 12 },
  { src: '/coffebeans.svg', mobileSize: 85, desktopSize: 260, opacity: 0.22, top: '48%', left: '1%', rotation: -10 },
  { src: '/coffebeans.svg', mobileSize: 80, desktopSize: 250, opacity: 0.21, top: '82%', left: '6%', rotation: 25 },
]
...
export function GlobalDecorations() {
  const globalDecorations = [
    ...
    { src: '/coffebeans.svg', mobileSize: 90, desktopSize: 280, opacity: 0.24, top: '12%', left: '5%', rotation: 12 },
    { src: '/coffebeans.svg', mobileSize: 85, desktopSize: 260, opacity: 0.21, top: '20%', left: '50%', rotation: -25 },
    { src: '/coffebeans.svg', mobileSize: 80, desktopSize: 250, opacity: 0.22, top: '58%', left: '6%', rotation: 25 },
    { src: '/coffebeans.svg', mobileSize: 85, desktopSize: 270, opacity: 0.2, top: '66%', left: '55%', rotation: -20 },
    { src: '/coffebeans.svg', mobileSize: 95, desktopSize: 300, opacity: 0.23, top: '72%', left: '4%', rotation: 15 },
  ]
